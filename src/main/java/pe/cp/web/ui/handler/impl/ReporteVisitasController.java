...
public class ReporteVisitasController implements IReporteVisitasHandler {
	...
	private final String REP_VISITAS_SEMANAL = "/pe/cp/reportes/cpr_visitas_semanal.jrxml";
	private final String REP_VISITAS_ANUAL = "/pe/cp/reportes/cpr_visitas_anual.jrxml";
	...
	private void generarReporteSemanal(String formato) {
		...
		if (view.getDfFiltro().getValue() != null){
			...
			obtenerReporte(formato, params, REP_VISITAS_SEMANAL);
		}else{
			notification = new Notification("Seleccionar fecha");
			notification.show(Page.getCurrent());
		}
	...
	private void generarReporteAnual(String formato) {
		...
		if (view.getDfFiltro().getValue() != null){
			...
			obtenerReporte(formato, params, REP_VISITAS_ANUAL);
		}else{
			notification = new Notification("Seleccionar fecha");
			notification.show(Page.getCurrent());
		}			
