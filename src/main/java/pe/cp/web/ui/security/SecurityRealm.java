...
public class SecurityRealm extends JdbcRealm {
	 ...
	 */
	protected static final String DEFAULT_AUTHENTICATION_QUERY = "SELECT password FROM usuario WHERE login = ?";

	/**
	 * The default query used to retrieve the roles that apply to a user.
	 */
	protected static final String DEFAULT_USER_ROLES_QUERY = 
			"SELECT r.DESROL FROM rolxusuario ru, usuario u, rol r "
            + " where ru.IDUSUARIO = u.IDUSUARIO and ru.IDROL=r.IDROL "
            + "and u.LOGIN=?";
